...
import { BACKSTOP_GREPS, CENTS_FLOAT_TYPE_PATTERN, SERVICE_ROLE_KEY_BARE_PATTERN } from "@/lib/ci/backstop-greps";
...
describe("SERVICE_ROLE_KEY_BARE_PATTERN (ADR-0007)", () => {
  it("flags any bare reference to SUPABASE_SERVICE_ROLE_KEY", () => {
    ...
    expect(SERVICE_ROLE_KEY_BARE_PATTERN.test('const k = env("SUPABASE_SERVICE_ROLE_KEY")')).toBe(true);
  });

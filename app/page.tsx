...
export default function HomePage() {
  return (
    <main className="min-h-screen flex flex-col items-center justify-center px-6">
      ...
      <h1 className="font-display text-5xl md:text-display text-center leading-none mb-6">
        A room. A game.<br />
        <em className="gold-text italic">A chair waiting for you.</em>
      </h1>
      <hr className="gold-rule-short my-6" />
      <p className="text-ivory-300 text-lg max-w-xl text-center leading-relaxed">
